...
public partial class SearchPage : Page
{
    ...
    private static readonly Binding _sourceBinding = new Binding(nameof(SearchPageViewModel.PlayItems))
    {
    ...
    {
        List<Beatmap> beatmaps = ViewModel.PlayItems.Select(k => k.Model).ToList();
    ...
    {
        var beatmap = ViewModel.PlayItems[e.Index].Model;
        try
        {
