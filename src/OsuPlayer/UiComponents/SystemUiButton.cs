...
public class MaxUiButton : SystemUiButton, INotifyPropertyChanged
{
    ...
    {
        if (_isSigned) return;
        HostWindow.StateChanged += (_, _) => RecoverState();
