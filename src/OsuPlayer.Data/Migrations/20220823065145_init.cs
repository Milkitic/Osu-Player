        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayItemStandardizedPath = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameMode = table.Column<byte>(type: "INTEGER", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    StandardizedPath = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    StandardizedFolder = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "IgnoredVersion", "LastSync", "LastUpdateCheck", "MinimalWindowPosition", "MinimalWindowWorkingArea", "ShowFullNavigation", "ShowMinimalWindow", "ShowWelcome" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayItems_StandardizedFolder",
                table: "PlayItems",
                column: "StandardizedFolder");

            migrationBuilder.CreateIndex(
                name: "IX_PlayItems_StandardizedPath",
                table: "PlayItems",
                column: "StandardizedPath",
                unique: true);
